...
!!!info
**Полные права:** Пользователи с полными правами уже имеют доступ ко всей подсистеме, включая функции 
...
!!!info
**Порядок применения:** Система сначала ищет настройки пользователя. Если они не заданы, то настройки группы,
