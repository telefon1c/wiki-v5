...
# Контакт-центр
Расширение для 1С:Предприятие, которое объединяет телефонию, мессенджеры и электронную
...
[!card layout="compact" title="AI сервисы" text="Анализ диалогов с помощью инструментов искусственного интеллекта"](ai/dialog-analyze.md)
[!card layout="compact" text="Работа с сообщениями в мобильном приложении Telegram"](messenger/telegram-center.md)
